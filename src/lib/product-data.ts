...
export const CATEGORIES: ConfiguratorCategory[] = [
  {
    ...
    label: "Gehäusefarbe",
    options: [
      { id: "anthracite_grey", label: "Anthrazitgrau", image: "/kitchen/casing/anthracite_grey.webp", priceDelta: 0, swatchColor: "#3c4145" },
      { id: "apollo_brushed_metallic", label: "Apollo Brushed Metallic", image: "/kitchen/casing/apollo_brushed_metallic.webp", priceDelta: 0, swatchColor: "#9a958c" },
      { id: "grey_metallic", label: "Grau Metallic", image: "/kitchen/casing/grey_metallic.webp", priceDelta: 0, swatchColor: "#8b8d8f" },
      { id: "dark_grey", label: "Dunkelgrau", image: "/kitchen/casing/dark_grey.webp", priceDelta: 0, swatchColor: "#55585c" },
      { id: "silver_metallic", label: "Silber Metallic", image: "/kitchen/casing/silver_metallic.webp", priceDelta: 0, swatchColor: "#b7b9bb" },
      { id: "black", label: "Schwarz", image: "/kitchen/casing/black.webp", priceDelta: 0, swatchColor: "#16171a" },
      { id: "white", label: "Weiß", image: "/kitchen/casing/white.webp", priceDelta: 0, swatchColor: "#f2f1ee" },
      { id: "carbon", label: "Carbon", image: "/kitchen/casing/carbon.webp", priceDelta: 0, swatchColor: "#23262b" },
      { id: "wood_line", label: "Wood-Line", image: "/kitchen/casing/wood_line.webp", priceDelta: 0, swatchColor: "#7a5a3a" },
    ],
  },
  {
    id: "fronts",
